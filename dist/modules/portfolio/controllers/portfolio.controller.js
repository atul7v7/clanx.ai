...
let PortfolioController = class PortfolioController {
    ...
    async insertPortfolio(portfolioDto) {
        const portfolio = await this.portfolioService.addPortfolio(portfolioDto);
        return response_handler_1.ResponseHandler.success(portfolio);
    }
    async getPortfolio() {
        const portfolioDetails = await this.portfolioService.getCompletePortfolio();
        return response_handler_1.ResponseHandler.success(portfolioDetails);
    }
    async avgBuyingPrice() {
        const avgPrice = await this.portfolioService.avgBuyingPrice();
        return response_handler_1.ResponseHandler.success(avgPrice);
    }
};
...
], PortfolioController.prototype, "insertPortfolio", null);
__decorate([
    (0, common_1.Get)(),
...
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], PortfolioController.prototype, "avgBuyingPrice", null);
